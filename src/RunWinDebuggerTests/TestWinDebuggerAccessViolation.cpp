...
CTestWinDebuggerAccessViolation::CTestWinDebuggerAccessViolation() {
	command_line_		= "TestWinDebuggerAccessViolation.exe";
	fuzzed_file_		= "";
	log_dir_			= "TestWinDebuggerAccessViolationLogs";
	debuggers_dir_		= "";
	symbols_path_		= "";
...
void CTestWinDebuggerAccessViolation::run() {
