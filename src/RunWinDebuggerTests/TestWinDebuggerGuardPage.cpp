...
CTestWinDebuggerGuardPage::CTestWinDebuggerGuardPage() {
	command_line_		= "TestWinDebuggerGuardPage.exe";
	fuzzed_file_		= "";
	log_dir_			= "TestWinDebuggerGuardPageLogs";
	debuggers_dir_		= "";
	symbols_path_		= "";
...
void CTestWinDebuggerGuardPage::run() {
