...
CTestWinDebuggerMaxExecutionTime::CTestWinDebuggerMaxExecutionTime() {
	command_line_		= "TestWinDebuggerMaxExecutionTime.exe";
	fuzzed_file_		= "";
	log_dir_			= "TestWinDebuggerMaxExecutionTimeLogs";
	debuggers_dir_		= "";
	symbols_path_		= "";
...
void CTestWinDebuggerMaxExecutionTime::run() {
