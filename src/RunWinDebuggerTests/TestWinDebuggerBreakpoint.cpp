...
CTestWinDebuggerBreakpoint::CTestWinDebuggerBreakpoint() {
	command_line_		= "TestWinDebuggerBreakpoint.exe";
	fuzzed_file_		= "";
	log_dir_			= "TestWinDebuggerBreakpointLogs";
	debuggers_dir_		= "";
	symbols_path_		= "";
...
void CTestWinDebuggerBreakpoint::run() {
