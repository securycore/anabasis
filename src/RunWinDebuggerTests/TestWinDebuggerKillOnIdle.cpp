...
CTestWinDebuggerKillOnIdle::CTestWinDebuggerKillOnIdle() {
	command_line_		= "TestWinDebuggerKillOnIdle.exe";
	fuzzed_file_		= "";
	log_dir_			= "TestWinDebuggerKillOnIdleLogs";
	debuggers_dir_		= "";
	symbols_path_		= "";
...
void CTestWinDebuggerKillOnIdle::run() {
